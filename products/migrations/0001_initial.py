# Generated by Django 2.0.5 on 2018-07-02 23:29
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('icon', models.ImageField(blank=True, null=True, upload_to='media/upload/icons/')),
                ('is_open', models.BooleanField(default=True, verbose_name='is_open')),
                ('flag', models.CharField(blank=True, max_length=10, null=True, verbose_name='标识')),
                ('disabled_show', models.BooleanField(default=False)),
                ('add_time', models.DateTimeField(default=datetime.datetime.now)),
                ('pcid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='products.Categorys')),
            ],
            options={
                'verbose_name': '类别',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pcid', models.CharField(max_length=10, null=True)),
                ('partner_price', models.FloatField(default=0.0, verbose_name='价格')),
                ('pre_img', models.ImageField(upload_to='media/upload/goods/pre_img/')),
                ('pre_imgs', models.ImageField(upload_to='media/upload/goods/pre_imgs/')),
                ('keywords', models.CharField(max_length=50, verbose_name='关键词')),
                ('p_cids', models.CharField(max_length=10, null=True)),
                ('cids', models.CharField(max_length=10, null=True)),
                ('product_id', models.CharField(max_length=10, verbose_name='商品编号')),
                ('img', models.ImageField(upload_to='media/upload/goods/img/')),
            ],
            options={
                'verbose_name': '商品',
